...
| 게시글 | **75개 공개** (91개 draft) | finance 63 + insurance 12 |
| **Google 색인** | **54개** | 노출 8,514 / 클릭 14 / CTR 0.2% |
| **Naver 색인** | **78개** (3/6 기준) | 클릭 ~120 / CTR 9.4% / 수집제한 36 |
| 도구 | **29개** | 금융 계산기 18 + 생활 2 + 시뮬레이터 4 + 기타 5 |
| 테스트 | **2개 공개** (8개 숨김) | 소비유형, 재테크성향 |
| AdSense | **4차 심사 중** | sseuksak.com "준비 중" (13일차), Ads.txt "승인됨" |
| GA4 | 설치됨 | G-CMZF467RLD |
| IndexNow | 적용 | 네이버, Bing, Yandex 자동 알림 |
| **AI 콘텐츠 품질** | **완료** | 95/95 리라이팅 + 166개 팩트체크 완료 |
