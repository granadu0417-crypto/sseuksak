...
| **Google 색인** | **54개** | 노출 8,658 / 클릭 15 / CTR 0.2% |
| **Naver 색인** | **90개** (3/10 기준) | 클릭 72 / CTR 5.9% / 수집제한 33 |
| 도구 | **29개** | 금융 계산기 18 + 생활 2 + 시뮬레이터 4 + 기타 5 |
| 테스트 | **2개 공개** (8개 숨김) | 소비유형, 재테크성향 |
| AdSense | **4차 심사 중** | sseuksak.com "준비 중" (14일차), Ads.txt "승인됨" |
...
### 우선순위 높음
- [ ] savings-account-comparison-2026 타이틀/메타 최적화 (Google 최대 노출 페이지, CTR 극히 낮음)
- [ ] AdSense 4차 심사 결과 확인 (2/25 제출, 13일차 — 곧 결과 예상)
- [ ] GSC 404 에러 14건 모니터링 (대부분 draft URL, 자연 해소 대기)

### 우선순위 중간
- [ ] Naver Search Advisor 수동 확인 (Playwright 로그인 대안 필요)
- [ ] Naver 수집제한 36건 모니터링 (3/6 수집 요청 7개 결과 확인)
